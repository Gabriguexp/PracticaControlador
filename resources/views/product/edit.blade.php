@extends('base')
@section('head')
    <title>Tienda Vergeles | Editar producto</title>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <form method="post" action="{{ url('products/'. $product['id']) }}">
                ...
                <input value="{{ $product['name'] }}" class="form-control "type="text" placeholder="Nombre" name="name"/>
                </div>
                <div class="form-group">
                <label for="price">Precio</label>
                <input value="{{ $product['price'] }}" class="form-control" placeholder="Precio" type="number" name="price"/>
                </div>
                <br>
